	    ...
	    public static void AddTask(Task task)
	    {
	        var strSql =
	            string.Format(
	                ...
	                task.TaskName, task.TaskDir, task.RootUrl, task.ParaUrlStart, task.ParaUrlEnd, task.RuleName, task.IsPicture, task.PictureUrlPrefix, task.ParaUrlLastDownloaded);
